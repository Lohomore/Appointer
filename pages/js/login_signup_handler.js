...
document.getElementById("months").addEventListener("change", validateMonth);
document.getElementById("days").addEventListener("change", validateDay);
document.getElementById("years").addEventListener("change", validateYear);
