...
document.getElementById("customerImage").addEventListener("mouseover", hoverProfilePic);
document.getElementById("customerImage").addEventListener("mouseout", offhoverProfilePic);
